...
public final class RxJava2CallAdapterFactory extends CallAdapter.Factory {
    ...
    public static RxJava2CallAdapterFactory createWithLifeCycle(Application application) {
        RxObservableLifeCycle.register(application);
        return new RxJava2CallAdapterFactory(Schedulers.io(), false);
    }
